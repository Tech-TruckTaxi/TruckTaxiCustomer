...
const SearchScreen = () => {
  ...
  const [placeHolder, setplaceHolder] = useState('Search For Pickup Location');
  ...
  return (
    <View style={styles.container}>
      <Autocomplete
        ...
        style={{
          width: '100%', backgroundColor: Color.white, borderColor: Color.primary, borderWidth: 1, borderRadius: 10,
          height: 50,
          color: "#000"
        }}
        autoCorrect={false}
